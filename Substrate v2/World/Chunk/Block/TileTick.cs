namespace Substrate_v2.World.Chunk.Block;
///<summary> Represents a TileTick record, which is used to queue a block for processing in the future. </summary>
public class TileTick : INbtObject<TileTick>, ICopyable<TileTick>
{
    ...
    /// <summary> Constructs an empty <see cref="TileTick"/> object. </summary>
    public TileTick() { }
    /// <summary> Constructs a <see cref="TileTick"/> by copying an existing one. </summary>
    ...
    public TileTick(TileTick tt)
    {
        ...
        X = tt.X;
        if (tt.source != null)
            source = tt.source.Copy() as TagNodeCompound;
    }
    /// <summary> Gets or sets the ID (type) of the block that this <see cref="TileTick"/> is associated with. </summary>
    public int ID { get; set; }
    /// <summary> Gets or sets the number of ticks remaining until the associated block is processed. </summary>
    public int Ticks { get; set; }
    /// <summary> Gets or sets the global X-coordinate of the block that this <see cref="TileTick"/> is associated with. </summary>
    public int X { get; set; }
    /// <summary> Gets or sets the global Y-coordinate of the block that this <see cref="TileTick"/> is associated with. </summary>
    public int Y { get; set; }
    /// <summary> Gets or sets the global Z-coordinate of the block that this <see cref="TileTick"/> is associated with. </summary>
    public int Z { get; set; }
    /// <summary> Checks whether the <see cref="TileTick"/> is located (associated with a block) at the specific global coordinates. </summary>
    ...
    public bool LocatedAt(int x, int y, int z) => X == x && Y == y && Z == z;
    /// <summary> Moves the <see cref="TileTick"/> by given block offsets. </summary>
    ...
    /// <summary> Attempt to construct a new <see cref="TileTick"/> from a Tile Entity subtree without validation. </summary>
    ...
    /// <summary> Attempt to construct a new <see cref="TileTick"/> from a Tile Entity subtree with validation. </summary>
    /// <param name="tree">The root node of a <see cref="TileTick"/> subtree.</param>
    ...
    /// <summary> Gets a <see cref="SchemaNode"/> representing the basic schema of a <see cref="TileTick"/>. </summary>
    public static SchemaNodeCompound Schema { get; }

    /// <summary> Attempt to load a <see cref="TileTick"/> subtree into the <see cref="TileTick"/> without validation. </summary>
    /// <param name="tree">The root node of a <see cref="TileTick"/> subtree.</param>
    ...
    /// <summary> Attempt to load a <see cref="TileTick"/> subtree into the <see cref="TileTick"/> with validation. </summary>
    /// <param name="tree">The root node of a <see cref="TileTick"/> subtree.</param>
    ...
    /// <summary> Builds a <see cref="TileTick"/> subtree from the current data. </summary>
    ...
    /// <summary> Validate a <see cref="TileTick"/> subtree against a basic schema. </summary>
    /// <param name="tree">The root node of a <see cref="TileTick"/> subtree.</param>
    ...
    /// <summary> Creates a deep-copy of the <see cref="TileTick"/> including any data defined in a subtype.</summary>
    /// <returns>A deep-copy of the <see cref="TileTick"/>.</returns>
    public virtual TileTick Copy() => new TileTick(this);
    #endregion
}
