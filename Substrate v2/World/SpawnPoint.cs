...
/// <summary> Represents the spawn point of a player or world. </summary>
...
{
    /// <summary> Gets the global X-coordinate of the spawn point (in blocks). </summary>
    public int X { get; }
    /// <summary> Gets the global Y-coordinate of the spawn point (in blocks). </summary>
    public int Y { get; }
    /// <summary> Gets the global Z-coordinate of the spawn point (in blocks). </summary>
    public int Z { get; }
    /// <summary> Creates a new spawn point. </summary>
    ...
    /// <summary> Checks if two <see cref="SpawnPoint"/> objects are considered equal. </summary>
    ...
    public bool Equals (SpawnPoint spawn) => X == spawn.X && Y == spawn.Y && Y == spawn.Y;
    /// <summary> Checks if two <see cref="SpawnPoint"/> objects are considered equal. </summary>
    /// <param name="o">An to compare against.</param>
    /// <returns>True if the two <see cref="SpawnPoint"/> objects are equal; false otherwise.</returns>
    public override bool Equals(object o) => o is SpawnPoint ? (this == (SpawnPoint)o) : false;
    /// <summary> Returns the hash code for this instance. </summary>
    /// <returns>A hash code for this instance.</returns>
    public override int GetHashCode () => ((23 * 37 + X) * 37 + Y) * 37 + Z;
    /// <summary> Checks if two <see cref="SpawnPoint"/> objects are considered equal. </summary>
    ...
    /// <summary> Checks if two <see cref="SpawnPoint"/> objects are considered unequal. </summary>
    /// <param name="k1">The first <see cref="SpawnPoint"/> in the comparison.</param>
    /// <param name="k2">The second <see cref="SpawnPoint"/> in the comparison.</param>
    /// <returns>True if the two <see cref="SpawnPoint"/> objects are not equal; false otherwise.</returns>
    public static bool operator != (SpawnPoint k1, SpawnPoint k2) => k1.X != k2.X || k1.Y != k2.Y || k1.Z != k2.Z;
    /// <summary> Returns a string representation of the <see cref="SpawnPoint"/>. </summary>
