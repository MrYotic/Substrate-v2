...
/// <summary> An abstract representation of any conforming chunk-based world. </summary>
...
public abstract class NbtWorld
{
    ...
    /// <summary> Creates a new instance of an <see cref="NbtWorld"/> object. </summary>
    protected NbtWorld () => DataDirectory = DATA_DIR;
    /// <summary> Gets or sets the path to the directory containing the world. </summary>
    public string Path { get; set; }
    /// <summary> Gets or sets the directory containing data resources, rooted in the world directory. </summary>
    public string DataDirectory { get; set; }
    /// <summary> Gets a reference to this world's <see cref="Level"/> object. </summary>
    public abstract Level Level { get; }
    /// <summary> Gets an <see cref="IBlockManager"/> for the default dimension. </summary>
    /// <returns>An <see cref="IBlockManager"/> tied to the default dimension in this world.</returns>
    public IBlockManager GetBlockManager () => GetBlockManagerVirt(Dimension.OverWorld);
    /// <summary> Gets an <see cref="IBlockManager"/> for the given dimension. </summary>
    ...
    public IBlockManager GetBlockManager (int dim) => GetBlockManagerVirt(dim);
    public IBlockManager GetBlockManager (string dim) => GetBlockManagerVirt(dim);
    /// <summary> Gets an <see cref="IChunkManager"/> for the default dimension. </summary>
    /// <returns>An <see cref="IChunkManager"/> tied to the default dimension in this world.</returns>
    public IChunkManager GetChunkManager () => GetChunkManagerVirt(Dimension.OverWorld);
    /// <summary> Gets an <see cref="IChunkManager"/> for the given dimension. </summary>
    /// <param name="dim">The id of the dimension to look up.</param>
    /// <returns>An <see cref="IChunkManager"/> tied to the given dimension in this world.</returns>
    public IChunkManager GetChunkManager (int dim) => GetChunkManagerVirt(dim);
    public IChunkManager GetChunkManager (string dim) => GetChunkManagerVirt(dim);
    /// <summary> Gets an <see cref="IPlayerManager"/> for maanging players on multiplayer worlds. </summary>
    /// <returns>An <see cref="IPlayerManager"/> for this world.</returns>
    public IPlayerManager GetPlayerManager () => GetPlayerManagerVirt();
    /// <summary> Gets a <see cref="DataManager"/> for managing data resources, such as maps. </summary>
    /// <returns>A <see cref="DataManager"/> for this world.</returns>
    public DataManager GetDataManager () => GetDataManagerVirt();

    /// <summary> Attempts to determine the best matching world type of the given path, and open the world as that type. </summary>
    ...
    /// <summary> Saves the world's <see cref="Level"/> data, and any <see cref="IChunk"/> objects known to have unsaved changes. </summary>
    public abstract void Save ();
    /// <summary> Raised when <see cref="Open"/> is called, used to find a concrete <see cref="NbtWorld"/> type that can open the world. </summary>
    protected static event EventHandler<OpenWorldEventArgs> ResolveOpen;
    /// <summary> Virtual implementor of <see cref="GetBlockManager(int)"/>. </summary>
    ...
    /// <summary> Virtual implementor of <see cref="GetChunkManager(int)"/>. </summary>
    ...
    /// <summary> Virtual implementor of <see cref="GetPlayerManager"/>. </summary>
    ...
    /// <summary> Virtual implementor of <see cref="GetDataManager"/> </summary>
