...
/// <summary> Creates new instances of concrete <see cref="TypedEntity"/> types from a dynamic registry. </summary>
...
public class EntityFactory
{
    ...
    /// <summary> Create a new instance of a concrete <see cref="TypedEntity"/> type by name. </summary>
    ...
    /// <summary> Create a new instance of a concrete <see cref="TypedEntity"/> type by NBT node. </summary>
    ...
    /// <summary> Creates a new instance of a nonspecific <see cref="TypedEntity"/> object by NBT node. </summary>
    ...
    /// <summary> Lookup a concrete <see cref="TypedEntity"/> type by name. </summary>
    /// <param name="type">The name that a concrete <see cref="TypedEntity"/> type was registered with.</param>
    ...
    /// <summary> Registers a new concrete <see cref="TypedEntity"/> type with the <see cref="EntityFactory"/>, binding it to a given name. </summary>
    ...
    /// <summary> Gets an enumerator over all registered Entities. </summary>
